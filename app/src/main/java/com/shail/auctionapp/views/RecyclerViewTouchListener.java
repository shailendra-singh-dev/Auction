...
public class RecyclerViewTouchListener<CollectionView extends ViewAdapter> implements
    ...
    // Fixed properties
    private CollectionView mRecyclerView;
    private DismissCallbacks<CollectionView> mCallbacks;
     ...
     */
    public RecyclerViewTouchListener(CollectionView recyclerView,
                                     DismissCallbacks<CollectionView> callbacks) {
        ViewConfiguration vc = ViewConfiguration.get(recyclerView.getContext());
        mSlop = vc.getScaledTouchSlop();
        mMinFlingVelocity = vc.getScaledMinimumFlingVelocity() * 16;
        mMaxFlingVelocity = vc.getScaledMaximumFlingVelocity();
        mAnimationTime = recyclerView.getContext().getResources().getInteger(R.integer.config_short_anim_time);
...
//            mHandler.postDelayed(mDismissRunnable, mDismissDelayMillis);
    ...
    public boolean existPendingDismisses() {
        return mPendingDismiss != null && null != mPendingDismiss.rowContainer && mPendingDismiss.rowContainer.dataContainerHasBeenDismissed;
    }
