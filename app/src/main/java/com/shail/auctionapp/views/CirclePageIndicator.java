...
import io.app..R;
import com.shail.auctionapp.interfaces.PageIndicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultPageColor = ContextCompat.getColor(context,R.color.circle_indicator_page_color);
        final int defaultFillColor = ContextCompat.getColor(context,R.color.circle_indicator_fill_color);
        final int defaultOrientation = res.getInteger(R.integer.circle_indicator_orientation);
        final int defaultStrokeColor = ContextCompat.getColor(context,R.color.circle_indicator_stroke_color);
        ...
        if (background != null) {
            AppUtils.setBackgroundDrawable(this,background);
        }
